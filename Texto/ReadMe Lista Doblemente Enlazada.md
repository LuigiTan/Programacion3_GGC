...
public: //Valores públicos  
    ...
    //Funcion insert  
    //Toma una posicion donde queremos que se inserte y una constante    //Se necesista un iterador y se manda la posicion como paramatro    //Baciamente se usa cuando se da un numero en vez de un iterador y lo traduce    
