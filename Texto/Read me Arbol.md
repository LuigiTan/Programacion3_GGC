A continuación se presenta la documentación de un Arbol Binario Autobalanceable 
```C++
#ifndef AVL_TREE_H  
#define AVL_TREE_H  
...
#include<algorithm>  
#include<memory>
//Obtiene la direccion real de un objeto  
...
Por convención, la altura de un árbol AVL nulo o vacío se define como -1.
